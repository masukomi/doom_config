...
(use-package centaur-tabs
  :demand
  :init
  ;; Must be set BEFORE package loads for C-c t keybindings to work
  ...
  ;; Add C-c t c to close current tab (not provided by default)
  (:map centaur-tabs-mode-map
        ("C-c t c" . centaur-tabs--kill-this-buffer-dont-ask)))
